...
// **************************
define('EMAIL_TEMPLATE_IN_HTML', 'fcf.email-in.html');
...
// *******************************
define('EMAIL_TEMPLATE_OUT_HTML', 'fcf.email-out.html');
...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'calvinheeres1@gmail.nl');
define('EMAIL_TO_NAME', 'Calvin Heeres');

define('EMAIL_TO_CC', '32044@ma-web.nl');
define('EMAIL_TO_CC_NAME', 'Max Montanus');

define('EMAIL_TO_BCC', '');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'calvinheeres@hotmail.com');
define('EMAIL_FROM_NAME', 'Contacts');
